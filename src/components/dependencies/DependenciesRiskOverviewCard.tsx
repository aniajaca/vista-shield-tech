            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-start">
                ...
                <div className="md:col-span-1 space-y-4">
                    ...
                    {appliedFactors.length > 0 && (
                        <div>
                            ...
                            {normalizedScore && finalScore && (
                                <p className="text-xs text-[#6B7280] mt-2">
                                    Normalized score × dependency-level multipliers = final
                                </p>
                            )}
                        </div>
                    )}
                     ...
                     {totalVulns > 0 && (
                         <div>
                             <h3 className="text-xs font-medium uppercase text-[#6B7280] tracking-wider mb-2">Vulnerability Breakdown</h3>
